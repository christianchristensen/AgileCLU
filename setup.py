...
setup(
    ...
    scripts=['bin/agilels', 'bin/agilefetch', 'bin/agilemkdir',
             'bin/agilepost', 'bin/agileprofile', 'bin/agilerm',
             'bin/agilermdir',  'bin/agilels.py', 'bin/agilefetch.py',
             'bin/agilemkdir.py', 'bin/agilepost.py', 'bin/agileprofile.py',
             'bin/agilerm.py', 'bin/agilermdir.py'],
